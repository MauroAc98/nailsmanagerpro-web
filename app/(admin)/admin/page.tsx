...
import { Building2, RefreshCw, Settings, MessageCircle, Wallet } from 'lucide-react';
...
export default function AdminHomePage() {
  ...
  return (
    <div style={{ minHeight: '100vh', padding: 24, display: 'flex', flexDirection: 'column', gap: 16 }}>
      ...
      >
        <Wallet size={20} color={colors.primaryDeep} strokeWidth={1.5} />
        <div>
          <p style={{ fontSize: 14, fontWeight: 600, color: colors.textStrong, margin: 0 }}>Mercado Pago por negocio</p>
          <p style={{ fontSize: 12, color: colors.subtext, margin: 0 }}>Cargar el access_token de la cuenta de MP de cada negocio</p>
        </div>
      </Link>
